...
export default function DepositPage() {
  ...
  const [sortField, setSortField] = useState<keyof DepositRow | null>(null);
  ...
  const [rows, setRows] = useState<DepositRow[]>([
    {
      ...
      checkout_date: "2024-03-20 11:00",
    },
    {
      deposit_id: "DP-002",
      booking_id: "BK-002",
      guest: "Sarah Johnson",
      haven: "Haven 1",
      deposit_amount: "₱6,000",
      status: "Processing",
      statusColor: "bg-indigo-100 text-indigo-700",
      checkout_date: "2024-03-22 11:00",
    },
    {
      deposit_id: "DP-003",
      booking_id: "BK-003",
      ...
      checkout_date: "2024-03-25 11:00",
    },
    {
      deposit_id: "DP-004",
      booking_id: "BK-004",
      ...
      checkout_date: "2024-03-27 11:00",
    },
    {
      deposit_id: "DP-005",
      booking_id: "BK-005",
      guest: "David Lee",
      haven: "Haven 2",
      deposit_amount: "₱9,000",
      status: "Pending",
      statusColor: "bg-yellow-100 text-yellow-700",
      checkout_date: "2024-03-30 11:00",
    },
  ]);
  ...
  const handleSort = (field: keyof DepositRow) => {
    if (sortField === field) {
  ...
  const setRowStatus = (deposit_id: string, status: DepositStatus, statusColor: string) => {
    setRows((prev) =>
      prev.map((row) =>
        row.deposit_id === deposit_id
          ? {
              ...row,
              status,
              statusColor,
  ...
  const deleteRow = (deposit_id: string) => {
    setRows((prev) => prev.filter((row) => row.deposit_id !== deposit_id));
  };
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (value === "all" || ["Pending", "Processing", "Returned", "Forfeited"].includes(value)) {
                  setFilterStatus(value as "all" | DepositStatus);
                }
                setCurrentPage(1);
              }}
              ...
              {paginatedRows.map((row) => (
                <tr key={row.deposit_id} className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  <td className="py-4 px-4 text-right">
                    <span className="font-bold text-gray-800 dark:text-gray-100 text-sm whitespace-nowrap">{row.deposit_amount}</span>
                  </td>
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <button
                        ...
                        title="Return"
                        type="button"
                        onClick={() => setRowStatus(row.deposit_id, "Returned", "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300")}
                      >
                      ...
                      <button
                        ...
                        title="Process"
                        type="button"
                        onClick={() => setRowStatus(row.deposit_id, "Processing", "bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300")}
                      >
                      ...
                      <button
                        ...
                        title="Delete"
                        type="button"
                        onClick={() => deleteRow(row.deposit_id)}
                      >
