  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Map Section */}
        <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-8 animate-fade-in slide-in-from-bottom duration-500">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
              <MapPin className="w-6 h-6 text-orange-600" />
              Our Location
            </h2>
            <p className="text-gray-600 mt-1">Staycation Haven PH, Quezon City, Metro Manila</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Address Card */}
          <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in slide-in-from-left duration-500 hover:shadow-xl transition-shadow">
          ...
          {/* Phone Card */}
          <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in slide-in-from-bottom duration-500 hover:shadow-xl transition-shadow" style={{ animationDelay: '100ms' }}>
            <div className="bg-gradient-to-br from-orange-500 to-yellow-500 p-4 rounded-lg w-fit mb-4">
              <Phone className="w-8 h-8 text-white" />
            </div>
            <h3 className="text-xl font-bold text-gray-800 mb-2">Phone</h3>
            <p className="text-gray-600 mb-2">+63 9232457609</p>
            <p className="text-sm text-gray-500">Call us anytime</p>
          </div>

          {/* Email Card */}
          <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in slide-in-from-bottom duration-500 hover:shadow-xl transition-shadow" style={{ animationDelay: '200ms' }}>
            <div className="bg-gradient-to-br from-orange-500 to-yellow-500 p-4 rounded-lg w-fit mb-4">
          ...
          {/* Hours Card */}
          <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in slide-in-from-right duration-500 hover:shadow-xl transition-shadow" style={{ animationDelay: '300ms' }}>
            <div className="bg-gradient-to-br from-orange-500 to-yellow-500 p-4 rounded-lg w-fit mb-4">
        ...
        {/* Directions Section */}
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 animate-fade-in slide-in-from-bottom duration-500">
          <div className="flex items-center gap-2 mb-6">
            <div className="bg-gradient-to-br from-orange-500 to-yellow-500 p-3 rounded-lg">
              <Navigation className="w-6 h-6 text-white" />
            </div>
            <h2 className="text-2xl font-bold text-gray-800">How to Get Here</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
                <span className="bg-orange-100 text-orange-600 px-3 py-1 rounded-full text-sm font-bold">By Car</span>
              </h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
                <span className="bg-orange-100 text-orange-600 px-3 py-1 rounded-full text-sm font-bold">Public Transport</span>
              </h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="text-orange-500 mt-1">"</span>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-gray-600 mb-4">Need help finding us?</p>
            <a
